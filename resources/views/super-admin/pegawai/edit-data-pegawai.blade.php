                        ...
                        <form method="POST" action="{{ url('/data-user/edit-user/update/' . $data->id) }}"
                            ...
                            <div class="row mb-3">
                                <label for="status_pernikahan"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Status Pernikahan') }}</label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="jumlah_anak" type="number"
                                        class="form-control @error('jumlah_anak') is-invalid @enderror" name="jumlah_anak"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select id="department" class="form-select" aria-label="Default select example"
                                        @error('department') is-invalid @enderror" name="department">
                                        ...
                                        <option value="Finance Accounting" @selected($data->department == 'Finance Accounting')>Finance Accounting
                                        </option>
                            ...
                            <div class="row mb-3">
                                <label for="golongan"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Golongan') }}</label>

                                <div class="col-md-6">
                                    <select id="golongan" class="form-select" aria-label="Default select example"
                                        @error('golongan') is-invalid @enderror" name="golongan"
                                        value="{{ old('golongan') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select id="kabupaten" class="form-select" aria-label="Default select example"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select id="kelurahan" class="form-select" aria-label="Default select example"
                            ...
                            <div class="row mb-3">
                                <label for="alamat"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Detail alamat') }}</label>
