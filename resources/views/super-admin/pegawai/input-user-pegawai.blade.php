    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/data-user/store-user') }}" enctype="multipart/form-data">
                        @csrf
                        {{-- NIK --}}
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nik" type="number" class="form-control text-light @error('nik') is-invalid @enderror" name="nik" value="{{ old('nik') }}" required autocomplete="nik">
