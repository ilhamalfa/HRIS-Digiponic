...
@section('content')
    ...
    <div class="row p-5 mt-5 justify-content-md-center">
        <div class="col-lg-1">
            <form action="{{ url('/career/filter') }}" method="get">
                <div class="dropdown">
        ...
        <div class="col-lg-6">
            <form class="nav-link d-none d-lg-flex search" action="{{ url('/career/search') }}" method="get">
    ...
    {{-- Vacancy Start --}}
    <h1 class="vacancy-title">AVABILE JOBS</h1>
