                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="provinsi" class="form-select" aria-label="Default select example" @error('province_id') is-invalid @enderror" name="province_id" value="{{ old('province_id') }}" required autocomplete="province_id">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="kabupaten" class="form-select" aria-label="Default select example" @error('regency_id') is-invalid @enderror" name="regency_id" value="{{ old('regency_id') }}" required autocomplete="regency_id">
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="kecamatan" class="form-select" aria-label="Default select example" @error('district_id') is-invalid @enderror" name="district_id" value="{{ old('district_id') }}" required autocomplete="district_id">
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="kelurahan" class="form-select" aria-label="Default select example" @error('village_id	') is-invalid @enderror" name="village_id	" value="{{ old('village_id	') }}" required autocomplete="village_id	">
                                </select>
