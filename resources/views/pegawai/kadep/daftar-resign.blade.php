            ...
            <div class="col-md-12">
                <div class="card bg-white">
                    <div class="card-header">
                        <h6 class="text-black fw-bold fs-3">Department Resign List {{ Auth::user()->department }}</h6>
                    </div>
                    <div class="card-body overflow-scroll">
                                ...
                                <ul class="dropdown-menu text-end">
                                    <li>
                                        <a class="dropdown-item text-white"
                                            href="{{ url('/kadep/daftar-resign?status=Menunggu Persetujuan') }}">
                                    ...
                                    <li>
                                        <a class="dropdown-item text-white"
                                            href="{{ url('/kadep/daftar-resign?status=Accepted') }}">
                                            <span>Accepted</span>
                                    ...
                                    <li>
                                        <a class="dropdown-item text-white"
                                            href="{{ url('/kadep/daftar-resign?status=Declined') }}">
                                            <span>Declined</span>
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addResign">
                                ...
                                @foreach ($datas as $index => $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a href="{{ url('kadep/daftar-resign/' . $data->id . '/Accept') }}"
                                                    class="btn btn-success">Accept</a>
                                                <a href="{{ url('kadep/daftar-resign/' . $data->id . '/Decline') }}"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content bg-white border-0">
                                    <div class="modal-header">
                                        <h1 class="text-black fw-bold fs-3" id="exampleModalLabel">Reisgn Form
                                        </h1>
