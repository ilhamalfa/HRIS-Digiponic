            ...
            <div class="col-md-12">
                <div class="card bg-white">
                    <div class="card-header">
                        <h6 class="text-black fw-bold fs-3">Department Licensing List {{ Auth::user()->department }}</h6>
                    </div>
                    <div class="card-body overflow-scroll">
                                ...
                                <ul class="dropdown-menu text-end">
                                    <li>
                                        <a class="dropdown-item text-white"
                                            href="{{ url('/kadep/daftar-perizinan?status=Menunggu Persetujuan') }}">
                                    ...
                                    <li>
                                        <a class="dropdown-item text-white"
                                            href="{{ url('/kadep/daftar-perizinan?status=Accepted') }}">
                                            <span>Accepted</span>
                                    ...
                                    <li>
                                        <a class="dropdown-item text-white"
                                            href="{{ url('/kadep/daftar-perizinan?status=Declined') }}">
                                            <span>Declined</span>
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addLicence">
                                ...
                                @foreach ($datas as $index => $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a href="{{ url('kadep/daftar-perizinan/' . $data->id . '/Accept') }}"
                                                    class="btn btn-success">Accept</a>
                                                <a href="{{ url('kadep/daftar-perizinan/' . $data->id . '/Decline') }}"
                        ...
                        {{-- Modal Form Start --}}
                        <div class="modal fade" id="addLicence" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
